...
Para obtener más información, consulte https://library.netapp.com/ecm/ecm_download_file/ECMLP2881273["Notas de la versión de herramientas de ONTAP para VMware vSphere 9.10"^].
